...
const Dashboard = () => {
  ...
  if (error) {
    return (
      <div className="p-8">
        <ErrorMessage
          message="We couldn't load dashboard stats. Check your connection and try again."
          onRetry={refetch}
        />
      </div>
    );
    ...
    return (
      <div className="p-8">
        <EmptyState
          ...
          message="No dashboard metrics are available right now. Try refreshing the page."
